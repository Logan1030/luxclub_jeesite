...
//        model.addAttribute("list", officeService.findAll());
	...
	public String save(Office office, Model model, RedirectAttributes redirectAttributes) {
		...
		office.setParentIds(" ");//清空parentIds
		...
		String id = office.getParentId() == 0 ? "" : office.getParentId().toString();
...
//		}
		return "redirect:" + adminPath + "/sys/office/list?id="+id+"&parentIds="+parentIds;
	}
