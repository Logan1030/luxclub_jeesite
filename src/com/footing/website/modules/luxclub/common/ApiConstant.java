...
//	//卡号 token缓存失效时间
//	public static int API_CACHE_CARDNO_TOKEN_INVALID_TIME = -21600;
	//登录 token缓存失效时间
	public static int API_CACHE_LOGIN_TOKEN_INVALID_TIME = -21600;
	//访问易宝缓存数据失效时间
	...
	/**-------------------------------操作终端-------------------------------*/
	/**website*/
	public static final String OP_TERM_DICT_WEBSITE = "WEBSITE";
	/**wechat*/
	...
	/**website*/
	public static final int OP_TERM_DICT_WEBSITE_TYPE = 0;
	/**android*/
	public static final int OP_TERM_DICT_ANDROID_TYPE = 1;
	/**ios*/
	public static final int OP_TERM_DICT_IOS_TYPE = 2;
