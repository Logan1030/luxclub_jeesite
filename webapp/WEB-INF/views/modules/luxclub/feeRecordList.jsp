...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/luxclub/feeRecord/">卡余额充值/消费列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="feeRecord" action="${ctx}/luxclub/feeRecord/" method="post" class="breadcrumb form-search">
