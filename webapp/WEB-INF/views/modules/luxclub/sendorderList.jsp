...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/luxclub/sendorder/">派单订单列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="order" action="${ctx}/luxclub/sendorder/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>订单状态</th>
				<th>备注信息</th>
				<shiro:hasPermission name="luxclub:sendorder:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="order">
			<tr>
				<td><a href="${ctx}/luxclub/sendorder/form?id=${order.id}">
					${order.orderCode}
				</a></td>
				<td>
					${order.businessName}
				...
				<shiro:hasPermission name="luxclub:sendorder:edit"><td>
    				<a href="${ctx}/luxclub/sendorder/form?id=${order.id}">去派单</a>
