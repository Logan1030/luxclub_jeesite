...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/luxclub/walletFeeRecord/">零钱包充值/消费列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="walletFeeRecord" action="${ctx}/luxclub/walletFeeRecord/" method="post" class="breadcrumb form-search">
