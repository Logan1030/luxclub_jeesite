...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/luxclub/feeRecord/">卡余额充值/消费列表</a></li>
		<li class="active"><a href="${ctx}/luxclub/feeRecord/form?id=${feeRecord.id}">卡余额充值/消费记录<shiro:hasPermission name="luxclub:feeRecord:edit">${not empty feeRecord.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="luxclub:feeRecord:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="feeRecord" action="${ctx}/luxclub/feeRecord/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="feeMoney" htmlEscape="false" class="input-xlarge" readonly="true"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<c:forEach items="${feeRecord.voucherArray}" var="pic">
					<img src="${pic}" width="400px" height="300px" alt=""></br></br>
				</c:forEach>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="luxclub:feeRecord:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
