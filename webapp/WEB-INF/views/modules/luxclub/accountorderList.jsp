...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/luxclub/accountorder/">结账订单列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="order" action="${ctx}/luxclub/accountorder/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>订单状态</th>
				<th>备注信息</th>
				<shiro:hasPermission name="luxclub:accountorder:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="order">
			<tr>
				<td><a href="${ctx}/luxclub/accountorder/form?id=${order.id}">
					${order.orderCode}
				</a></td>
				<td>
				${order.memberCardno}
				...
				<shiro:hasPermission name="luxclub:accountorder:edit">
					<td>
	    				<a href="${ctx}/luxclub/accountorder/form?id=${order.id}">去结账</a>
					</td>
				</shiro:hasPermission>
			</tr>
		</c:forEach>
